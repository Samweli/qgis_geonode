...
class PluginProvider(QgsSourceSelectProvider):
    ...
    def createDataSourceWidget(self, parent, fl, widgetMode):
        return ProviderWidget(parent, fl, widgetMode)
...
class ProviderWidget(QgsAbstractDataSourceWidget, WidgetUi):
    def __init__(self, parent, fl, widgetMode):
        super(ProviderWidget, self).__init__(parent, fl, widgetMode)
        self.setupUi(self)
